...
let protectedPageHtml: string | undefined
...
export const getProtectedPageHtml = (): string => {
  if (!protectedPageHtml) {
    const htmlPath = getHtmlPath('protected.html')
    protectedPageHtml = readFileSync(htmlPath, 'utf-8')
  }

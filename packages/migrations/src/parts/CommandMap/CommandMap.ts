...
import { addRepositoryLink } from '../AddRepositoryLink/AddRepositoryLink.ts'
import { cleanPackageJson } from '../CleanPackageJson/CleanPackageJson.ts'
...
export const commandMap = {
  ...
  '/migrations2/add-repository-link': wrapCommand(addRepositoryLink),
  '/migrations2/clean-package-json': wrapCommand(cleanPackageJson),
